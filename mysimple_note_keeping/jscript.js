!(function (e, t) {
  ...
  function E(e, t, n) {
    ...
    return "!" !== e[0].charAt(0)
      ...
      : { type: "image", raw: n, href: r, title: i, text: U(s) };
  }
  var D = (function () {
      function e(e) {
        this.options = e || q;
      ...
      return (
          ...
          if (t) {
            ...
            if (n.header.length === n.align.length) {
              ...
              for (r = n.cells.length, i = 0; i < r; i++)
                n.cells[i] = C(n.cells[i], n.header.length);
              return n;
            }
          }
        }),
        ...
        (t.autolink = function (e, t) {
          ...
          if (n) {
            var r,
              i =
                "@" === n[2]
                  ? "mailto:" + (r = U(this.options.mangle ? t(n[1]) : n[1]))
                  : (r = U(n[1]));
            return {
              type: "link",
              raw: n[0],
        ...
        (t.url = function (e, t) {
          ...
          if ((n = this.rules.inline.url.exec(e))) {
            if ("@" === n[2])
              i = "mailto:" + (r = U(this.options.mangle ? t(n[0]) : n[0]));
            else {
              for (
                ;
                (s = n[0]),
            ...
            var i = t
              ? this.options.sanitize
                ? this.options.sanitizer
                  ...
                  : U(r[0])
                : r[0]
              : U(this.options.smartypants ? n(r[0]) : r[0]);
          ...
          for (; e; )
            if ((s = this.tokenizer.escape(e)))
              ...
              (e = e.substring(s.raw.length)),
                (s.tokens = this.inlineTokens(s.text, [], n, r)),
                t.push(s);
            else if ((s = this.tokenizer.autolink(e, J)))
              (e = e.substring(s.raw.length)), t.push(s);
            else if (n || !(s = this.tokenizer.url(e, J))) {
              if ((s = this.tokenizer.inlineText(e, r, H)))
                (e = e.substring(s.raw.length)),
                  (i = s.raw.slice(-1)),
                  t.push(s);
              else if (e) {
            ...
            switch ((u = e[w]).type) {
              ...
              case "heading":
                x += this.renderer.heading(
                  ...
                  u.depth,
                  se(this.parseInline(u.tokens, this.textRenderer)),
                  this.slugger
                );
                continue;
              case "code":
  ...
  return (
    ...
    (ge.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && ge.walkTokens(n, t.walkTokens), le.parseInline(n, t)
        );
      } catch (e) {
        if (
          ((e.message +=
